...
// Pobranie pytań z bazy danych z tabeli 'poziom_sredni'
$rezultat = $polaczenie->query("SELECT * FROM poziom_sredni");
...
<head>
    ...
    <title>QUIZ - POZIOM ŚREDNI</title>
