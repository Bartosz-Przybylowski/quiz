...
// Pobranie pytań z bazy danych z tabeli 'poziom_trudny'
$rezultat = $polaczenie->query("SELECT * FROM poziom_trudny");
...
<head>
    ...
    <title>QUIZ - POZIOM TRUDNY</title>
